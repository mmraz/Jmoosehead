...
/**
 * Home object for domain model class Attributes.
 * @see org.mraz.moose.Attributes
 * @author Hibernate Tools
 */
public class AttributesHome {

	private static final Log log = LogFactory.getLog(AttributesHome.class);
	...
	public void persist(Attributes transientInstance) {
		log.debug("persisting Attributes instance");
		try {
	...
	public Attributes merge(Attributes detachedInstance) {
		...
		try {
			Attributes result = (Attributes) sessionFactory.getCurrentSession()
	...
	public Attributes findById(java.lang.Integer id) {
		log.debug("getting Attributes instance with id: " + id);
		try {
			Attributes instance = (Attributes) sessionFactory
					.getCurrentSession().get("org.mraz.moose.Attributes", id);
			if (instance == null) {
	...
	public List findByExample(Attributes instance) {
		log.debug("finding Attributes instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.mraz.moose.Attributes")
