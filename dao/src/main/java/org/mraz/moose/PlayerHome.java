...
public class PlayerHome {
	...
	public Player merge(Player detachedInstance) {
		...
		try {
			Player result = (Player) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Player findById(java.util.Date id) {
		log.debug("getting Player instance with id: " + id);
		try {
			Player instance = (Player) sessionFactory.getCurrentSession().get(
					"org.mraz.moose.Player", id);
			if (instance == null) {
	...
	public List findByExample(Player instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.mraz.moose.Player")
